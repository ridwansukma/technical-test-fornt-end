        ...
        <>
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton className="custom-header-modal">
                    <Modal.Title className="custom-title-modal">Filter Pokedex</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <div className="row">
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" onClick={handleFilter} disabled={( getFilter !== '' && getAttribute !== '' ) ? false : true }>
                        Filter
                    </Button>
                </Modal.Footer>
            </Modal>
